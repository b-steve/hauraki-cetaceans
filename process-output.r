...
model.ext <- c("fixed-p", "fixed", "fixed-s", "fixed-t", "fixed-s-p", "fixed-t-p", "fixed-s-int", "fixed-t-int", "fixed-s-int-p", "fixed-t-int-p", "st-add", "st-add-p", "st-add-int", "st-add-int-p", "int-p-sst", "int", "int-nofixed", "st-p", "st", "st-nofixed", "sv", "sv-p")
